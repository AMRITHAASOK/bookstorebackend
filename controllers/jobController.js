...
exports.addJobs=async(req,res)=>{
    ...
    const {title,location,jobType,salary,qualification,expericence,description} = req.body
   ...
   try{
      ...
      if(existingJob){
        ...
        const newJob = new jobs({
          title,location,jobType,salary,qualification,expericence,description   })
        await newJob.save()
...
exports.deleteAJobs=async(req,res)=>{
